...
- I focused on **NoSQL injection, command injection, and LDAP injection**, running controlled tests against designated test environments.
...
## 2. Technical Support Engineer Intern
**Network TechLab Pvt. Ltd.** · Dec 2023 - Jan 2024

- I supported the security operations team by assisting with **alert triage** using the Atmos Secure SIEM platform.
- My day-to-day responsibility involved reviewing **20+ phishing-related alerts** across multiple client environments.
...
- I conducted research focused on **Deep and Dark Web intelligence gathering** as part of an academic security initiative.
